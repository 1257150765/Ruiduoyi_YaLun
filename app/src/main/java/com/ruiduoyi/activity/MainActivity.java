...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent  intent_service=new Intent(this, GpioService.class);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                ...
                case 0x101:
                    ...
                    view.setImageResource(R.drawable.gpio_true);
                    break;
                case 0x102:
                    ImageView view2=(ImageView)msg.obj;
                    view2.setImageResource(R.drawable.gpio_false);
                    break;
                case 0x104:
    ...
    public void initView(){
        ...
        viewPagerAdapter.addFragment(infoFragment,getResources().getString(R.string.production_information));
        viewPagerAdapter.addFragment(statusFragment,getResources().getString(R.string.engineering_status));
        viewPagerAdapter.addFragment(testFragment,"作业指导");
    ...
    private void AutoUpdateApp(){
        ...
        String delay_time = RdyApplication.delay_time;
    ...
    public void hideBtn(boolean hide){
        statusFragment.setHideButton(hide);
    }
